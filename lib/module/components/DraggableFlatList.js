...
function DraggableFlatListInner(props) {
  ...
  const drag = useStableCallback((activeKey) => {
    ...
    if (index !== undefined) {
      ...
      onDragBegin === null || onDragBegin === void 0
        ? void 0
        : onDragBegin(index);
    }
  });
  const onContainerLayout = ({ nativeEvent: { layout } }) => {
    ...
    (_props$onContainerLay = props.onContainerLayout) === null ||
    _props$onContainerLay === void 0
      ? void 0
      : _props$onContainerLay.call(props, {
          layout,
          containerRef,
        });
  };
  ...
  const onRelease = useStableCallback((index) => {
    ...
    (_props$onRelease = props.onRelease) === null || _props$onRelease === void 0
      ? void 0
      : _props$onRelease.call(props, index);
  });
  ...
  const onPlaceholderIndexChange = useStableCallback((index) => {
    ...
    (_props$onPlaceholderI = props.onPlaceholderIndexChange) === null ||
    _props$onPlaceholderI === void 0
      ? void 0
      : _props$onPlaceholderI.call(props, index);
  });
  ...
  const onViewableItemsChanged = useStableCallback((info) => {
    ...
    (_props$onViewableItem = props.onViewableItemsChanged) === null ||
    _props$onViewableItem === void 0
      ? void 0
      : _props$onViewableItem.call(props, info);
  });
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        props.renderPlaceholder &&
          /*#__PURE__*/ React.createElement(PlaceholderItem, {
        ...
        !!props.onScrollOffsetChange &&
          /*#__PURE__*/ React.createElement(ScrollOffsetListener, {
